...
from ..sampling.audio_vid_txt import audio_video_sample
...
class AudioVideoTextTrainer(BaseTrainer):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

        model_id = getattr(self.model_cfg, "model_id", "vid2audio_txt")
        ...
        self.text_encoder = T5EncoderModel.from_pretrained(text_encoder).bfloat16().eval().to(self.device)
